...
IFS=' ' read -ra INSTANCES <<< $(aws elbv2 describe-target-health --target-group-arn $TARGET_GROUP --region $REGION --query "TargetHealthDescriptions[?TargetHealth.State=='healthy'].Target.Id" | $
